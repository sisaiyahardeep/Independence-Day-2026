...
.glass-card {
    ...
    box-shadow: 0 8px 32px 0 rgba(0, 0, 0, 0.3), inset 0 1px 2px rgba(255,255,255,0.4), inset 0 -1px 2px rgba(0,0,0,0.2);
    border-radius: 20px;
}
...
.big-css-flag {
    ...
    box-shadow: 0 20px 60px rgba(0,0,0,0.6), inset 0 0 50px rgba(255,255,255,0.2);
}
@keyframes clothWave {
    0%, 100% { transform: perspective(1000px) rotateY(15deg) rotateX(5deg) scale(1.1); }
    50% { transform: perspective(1000px) rotateY(-15deg) rotateX(-5deg) scale(1.1) translateY(-10px); }
}
