...
function createBalloon() {
    ...
    // Float speed: smooth float to the top
    ...
    // Ensure smooth removal from DOM upon reaching the negative Y position (top)
...
function startBalloons() {
    ...
    // 50% faster spawn rate for continuous generation
